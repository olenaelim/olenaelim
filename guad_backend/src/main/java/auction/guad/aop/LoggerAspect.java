...
public class LoggerAspect {
	@Pointcut("execution(* board..interceptor.*Interceptor.*(..)) || execution(* board..controller.*Controller.*(..)) || execution(* board..service.*ServiceImpl.*(..)) || execution(* board..mapper.*Mapper.*(..))")
